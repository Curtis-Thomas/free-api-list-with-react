  ...
  return (
    <Box>
        ...
        <Box>
            ...
            <Endpoints header="GET" endpoint="/hello" description="As an example, to get definition of English word hello, you can send request to the above endpoint, you can choose any word of your choice by modifying the 'hello' in the above endpoint " />
        </Box>
    </Box>
  )
}
