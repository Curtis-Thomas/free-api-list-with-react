  ...
  return (
    <Box>
        ...
        <Box>
            ...
            <Endpoints header="GET" endpoint="/ip.json" description="This endpoint provides the requester's IP address. Please note that multiple IP lookups are not supported on this endpoint. If you prefer the response in plain text, you may remove the '.json' from the endpoint." />
            <Endpoints header="GET" endpoint="/ip/country.json" description="This endpoint provides information about the country associated with the requesting IP. There are multiple plain text endpoints available, allowing you to specify whether you prefer the full country name or just the country code. If you wish to receive only the country code, you can simply remove the '.json' from the endpoint." />
            <Endpoints header="GET" endpoint="/ip/geo.json" description="This endpoint contains geographical information about an IP, such as its latitude and longitude, along with the owning (ASN) organisiation." />
        </Box>
    </Box>
  )
}
